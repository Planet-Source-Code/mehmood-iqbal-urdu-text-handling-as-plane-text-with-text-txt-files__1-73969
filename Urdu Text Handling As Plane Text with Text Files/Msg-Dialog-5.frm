...
Begin VB.Form Dialog5 
   ...
   Begin Urdu_Text_Handling_As_Plane_Text.jcbutton jcbutton2 
      Height          =   615
      Left            =   1320
      TabIndex        =   2
      Top             =   960
      ...
      BackColor       =   0
      Caption         =   ""
      PictureNormal   =   "Msg-Dialog-5.frx":0A02
      PictureAlign    =   3
      CaptionEffects  =   3
      TooltipBackColor=   0
   End
   Begin Urdu_Text_Handling_As_Plane_Text.jcbutton jcbutton1 
      ...
      BackColor       =   0
      Caption         =   ""
      PictureNormal   =   "Msg-Dialog-5.frx":1414
      PictureAlign    =   3
      CaptionEffects  =   3
      TooltipBackColor=   0
   End
...
'Call Unload all form's Function
