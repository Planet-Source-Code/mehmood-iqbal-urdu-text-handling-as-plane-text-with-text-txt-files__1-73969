...
Begin VB.UserControl XP_ProgressBar 
   ...
   ScaleHeight     =   990
   ScaleWidth      =   3000
   ToolboxBitmap   =   "XP-PRO~1.ctx":0000
End
...
'This Progress-Bar Control is by Third Party got from PSC.
'No-Origional Terms & Conditions found on source code of
'this control, So, following it as Open-Copyright © laws.
'(Author, Urdu Text Handling Project)
...
Public Property Let ShowInTask(ByVal bShowInTask As Boolean)
   m_ShowInTask = bShowInTask
   If m_ShowInTask Then
        AddTotray Form1, ""
        ProgressInTask.Progress_HDC = HDC
   Else
